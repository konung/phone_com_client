...
# Unit tests for PhoneComClient::CreateContactParams
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateContactParams' do
  before do
    # run before each test
    @instance = PhoneComClient::CreateContactParams.new
  end
  ...
  describe 'test an instance of CreateContactParams' do
    it 'should create an instance of CreateContactParams' do
      expect(@instance).to be_instance_of(PhoneComClient::CreateContactParams)
    end
  end
