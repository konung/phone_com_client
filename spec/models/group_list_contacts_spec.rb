...
# Unit tests for PhoneComClient::GroupListContacts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GroupListContacts' do
  before do
    # run before each test
    @instance = PhoneComClient::GroupListContacts.new
  end
  ...
  describe 'test an instance of GroupListContacts' do
    it 'should create an instance of GroupListContacts' do
      expect(@instance).to be_instance_of(PhoneComClient::GroupListContacts)
    end
  end
