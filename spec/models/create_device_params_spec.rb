...
# Unit tests for PhoneComClient::CreateDeviceParams
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateDeviceParams' do
  before do
    # run before each test
    @instance = PhoneComClient::CreateDeviceParams.new
  end
  ...
  describe 'test an instance of CreateDeviceParams' do
    it 'should create an instance of CreateDeviceParams' do
      expect(@instance).to be_instance_of(PhoneComClient::CreateDeviceParams)
    end
  end
