...
# Unit tests for PhoneComClient::DeviceMembership
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeviceMembership' do
  before do
    # run before each test
    @instance = PhoneComClient::DeviceMembership.new
  end
  ...
  describe 'test an instance of DeviceMembership' do
    it 'should create an instance of DeviceMembership' do
      expect(@instance).to be_instance_of(PhoneComClient::DeviceMembership)
    end
  end
