...
# Unit tests for PhoneComClient::AvailableNumbersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AvailableNumbersApi' do
  before do
    # run before each test
    @instance = PhoneComClient::AvailableNumbersApi.new
  end
  ...
  describe 'test an instance of AvailableNumbersApi' do
    it 'should create an instance of AvailableNumbersApi' do
      expect(@instance).to be_instance_of(PhoneComClient::AvailableNumbersApi)
    end
  end
