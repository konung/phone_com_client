...
# Unit tests for PhoneComClient::NumberRegionsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NumberRegionsApi' do
  before do
    # run before each test
    @instance = PhoneComClient::NumberRegionsApi.new
  end
  ...
  describe 'test an instance of NumberRegionsApi' do
    it 'should create an instance of NumberRegionsApi' do
      expect(@instance).to be_instance_of(PhoneComClient::NumberRegionsApi)
    end
  end
