...
# Unit tests for PhoneComClient::PhoneNumbersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PhoneNumbersApi' do
  before do
    # run before each test
    @instance = PhoneComClient::PhoneNumbersApi.new
  end
  ...
  describe 'test an instance of PhoneNumbersApi' do
    it 'should create an instance of PhoneNumbersApi' do
      expect(@instance).to be_instance_of(PhoneComClient::PhoneNumbersApi)
    end
  end
